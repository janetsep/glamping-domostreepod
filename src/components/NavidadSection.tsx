...
import { navidadDetailContent } from "@/data/content/celebrations";
...
const NavidadSection = () => {
  ...
  return (
    <Section
      title={navidadDetailContent.title}
      subtitle={navidadDetailContent.subtitle}
      centered
      ...
      <div className="max-w-6xl mx-auto">
        <Tabs defaultValue="que-incluye" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8 bg-gradient-to-r from-primary to-pink-500 p-1">
            {navidadDetailContent.tabs.map((tab) => (
              <TabsTrigger 
                key={tab.id} 
                value={tab.id} 
                    ...
                    <div className="order-2 lg:order-1">
                      ...
                      <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <Button 
                          ...
                          onClick={() => navigate('/unit/navidad-package')}
                        >
                          Reservar Navidad
                        </Button>
                      </div>
