...
import { fiestasPatriasDetailContent } from "@/data/content/celebrations";
...
const FiestasPatriasSection = () => {
  ...
  return (
    <Section
      title={fiestasPatriasDetailContent.title}
      subtitle={fiestasPatriasDetailContent.subtitle}
      centered
      ...
      <div className="max-w-6xl mx-auto">
        <Tabs defaultValue="que-incluye" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8 bg-gradient-to-r from-primary to-pink-500 p-1">
            {fiestasPatriasDetailContent.tabs.map((tab) => (
              <TabsTrigger 
                key={tab.id} 
                value={tab.id} 
                    ...
                    <div className="order-2 lg:order-1">
                      ...
                      <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <Button 
                          ...
                          onClick={() => navigate('/unit/fiestas-patrias-package')}
                        >
                          Reservar Fiestas Patrias
                        </Button>
                      </div>
                    </div>
...
export default FiestasPatriasSection;