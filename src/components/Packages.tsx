  ...
  return (
    <section id="packages" className="py-20 bg-secondary/10">
      ...
      <div className="container mx-auto px-4">
        ...
        <PackageCTAs 
          onMainCTAClick={handleReservationClick}
          onViewAvailabilityClick={() => handleUnitClick("48a7a330-ebae-4e79-8f53-31a84ac900d9")}
        />
        
        <CountdownTimer initialTimeLeft={{ days: 3, hours: 8, minutes: 45 }} />
      </div>
    </section>
  );
};
