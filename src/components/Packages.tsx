...
const Packages = ({
  ...
  return <section id="packages" className="py-20 bg-secondary/10">
      ...
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-display font-bold text-primary mb-4 text-center">Nuestros Domos</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 mb-16">
          {packageData.map(pkg => <PackageCard key={pkg.id} pkg={pkg} hoveredUnit={hoveredUnit} expandedUnit={expandedUnit} setHoveredUnit={setHoveredUnit} toggleExpandUnit={toggleExpandUnit} handleUnitClick={handleUnitClick} />)}
        </div>
