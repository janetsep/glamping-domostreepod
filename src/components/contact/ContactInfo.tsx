      ...
      <div className="space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <a href="https://wa.me/56912345678" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-cyan-500 transition-colors">+56 9 8464 3307</a>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <a href="tel:+56912345678" className="text-gray-600 hover:text-cyan-500 transition-colors">+56 9 8464 3307</a>
            <p className="text-sm text-gray-500 mt-1">Atención de 9:00 a 18:00 hrs</p>
          </div>
        </div>
