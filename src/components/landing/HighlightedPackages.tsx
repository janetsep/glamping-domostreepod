  ...
  return <section className="py-16 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {highlightedPackages.map(pkg => <div key={pkg.id} className="relative overflow-hidden rounded-xl group cursor-pointer transition-all duration-300 hover:shadow-xl" onClick={() => navigate(`/unit/${pkg.id}`)}>
              {/* Background Image */}
              <div className="relative h-80 w-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  {/* CTA Button */}
                  <Button className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-3 rounded-lg transition-colors duration-200" onClick={e => {
                e.stopPropagation();
        ...
        <div className="text-center mt-12 bg-white p-8 rounded-2xl shadow-lg max-w-4xl mx-auto">
          ...
          <Button size="lg" className="bg-primary hover:bg-primary/90 text-white" onClick={() => navigate('/paquetes')}>
