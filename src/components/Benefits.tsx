...
import { 
  Flame, Tent, Utensils, Star, Map, 
  Bath, Heart, Bike, Mountain, Coffee, 
  Carrot, Leaf, Wifi, Gamepad, ParkingMeter, Plug 
} from "lucide-react";
...
const Benefits = () => {
  ...
  const categories = [
    { id: "wellness", label: "Wellness", icon: <Bath size={20} className="mr-2" /> },
    { id: "aventura", label: "Aventura", icon: <Mountain size={20} className="mr-2" /> },
    { id: "gastronomia", label: "Gastronomía", icon: <Utensils size={20} className="mr-2" /> },
    { id: "comodidades", label: "Comodidades Extra", icon: <Wifi size={20} className="mr-2" /> }
  ];
    ...
    <section id="benefits" className="py-20 bg-white">
      ...
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-center text-gray-600 mb-10 max-w-3xl mx-auto">
          Todo lo que necesitas para una experiencia inolvidable en medio de la naturaleza
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {activeExperience.items.map((item, index) => (
            <div 
              key={index} 
