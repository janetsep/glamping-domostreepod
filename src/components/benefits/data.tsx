...
export const experiencesData: ExperiencesData = {
  banos: {
    ...
    items: [{
      ...
      image: "/lovable-uploads/c700331d-fe37-40f0-bbb8-9977451cd4ee.png"
    }, {
      icon: <StarIcon />,
      ...
      image: "/lovable-uploads/f3aa9d7b-29da-4013-880d-5ff82577a66d.png"
    }]
  },
  recorridos: {
  ...
  historias: {
    ...
    items: [{
      ...
      image: "/lovable-uploads/1210456a-23fc-402f-a5b0-a5087ddc582a.png"
    }, {
      icon: <BookIcon />,
