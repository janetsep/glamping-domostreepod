...
import { womenRelaxDetailContent } from "@/data/content/celebrations";
...
const WomenRelaxSection = () => {
  ...
  return (
    <Section
      title={womenRelaxDetailContent.title}
      subtitle={womenRelaxDetailContent.subtitle}
      centered
      ...
      <div className="max-w-6xl mx-auto">
        <Tabs defaultValue="que-incluye" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8 bg-gradient-to-r from-primary to-pink-500 p-1">
            {womenRelaxDetailContent.tabs.map((tab) => (
              <TabsTrigger 
                key={tab.id} 
                value={tab.id} 
                    ...
                    <div className="order-2 lg:order-1">
                      ...
                      <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <Button 
                          ...
                          onClick={() => navigate('/unit/mujeres-relax-package')}
                        >
                          Reservar Mujeres Relax
                        </Button>
                      </div>
                    </div>
