      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 mb-4">Domos Treepod nació en 2017 de la visión de Janet y Jaime, quienes tras años de soñar en desarrollar una experiencia única, de la mano de la hospitalidad y gestión turística, decidieron crear junto a toda la familia, un concepto que trascendiera el turismo tradicional en Valle Las Trancas, evolucionando hacia un modelo regenerativo que impactará positivamente en el entorno.</p>
            <p className="text-gray-700 mb-4">
