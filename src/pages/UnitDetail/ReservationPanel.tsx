...
export const ReservationPanel = ({
  ...
  return (
    <div data-testid="reservation-panel" className="lg:sticky lg:top-0 lg:h-screen lg:overflow-y-auto bg-white lg:border-l border-gray-200 p-4 lg:p-5 mb-6 lg:mb-0 rounded-lg lg:rounded-none shadow-lg lg:shadow-none">
